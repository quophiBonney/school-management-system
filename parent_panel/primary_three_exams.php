...
<title>Primary Three Exam Records</title>
<!--Custom CSS -->
...
<form action="controllers/authController3.php" method="POST" class="d-flex justify-content-center">
...
<h4 class="text-dark">
        EXAMINATION SCORE OF PRIMARY THREEE STUDENTS
</h4>
</div> 
    ...
    <div class="row">
      <table class="table-stripped table-bordered">
        ...
        <tbody>
            ...
            $sql = "SELECT studentName, maths, english, science, creative_art, rme, ict, total, position, remarks FROM classThree";

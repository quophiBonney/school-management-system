 ...
 <div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <h4 class="text-center p-3">PRIMARY 6 ADMISSION FORM  <button type="button" id="btn" data-dismiss="modal" class="btn btn-danger ml-3"><i class="fa fa-close"></i></button></h4>
            <hr>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="awards-message">
          <h4 class="text-center mt-1 p-1 shadow">PRIMARY SIX STUDENTS LIST</h4>
        </div>
      </div>
      <table class="table table-stripped table-bordered">
        ...
        <tbody>
            ...
            $sql = "SELECT studentName, dob, parentName, parentMobile, image, date FROM primarySix";

...
<body> 
<div class="container-fluid mt-3 justify-content-center text-center align-items-center">
<form action="controllers/authController4.php" method="POST" class="d-flex justify-content-center">
<div class="form-group w-50 ml-5">
    <input type="text" name="name" placeholder="Search student name in full" class="form-control text-center text-dark border-light">
</div>
...
<h4 class="text-dark">
        EXAMINATION SCORE OF PRIMARY FOUR STUDENTS
</h4>
</div> 
    ...
    <div class="row">
      <table class="table-stripped table-bordered">
        ...
        <tbody>
            ...
            $sql = "SELECT studentName, maths, english, science, creative_art, rme, ict, total, position, remarks FROM classFour";

...
if(isset($_POST['search'])){
    $name = $_POST['name'];
    $sql = "SELECT studentName, maths, english, science, creative_art, rme, ict, total, position, remarks FROM classFour WHERE studentName = '".$_POST['name']."'";
    ...
    <div class="row">
      <table class="table-bordered">
        ...
        <tbody>
            <?php
            $conn = mysqli_connect("localhost", "root", "", "staff");
            $sql = "SELECT studentName, maths, english, science, creative_art, rme, ict, total, position, remarks FROM classFour WHERE studentName = '$name'";
            $query = mysqli_query($conn, $sql);

...
/** Primary Three Search **/
if(isset($_POST['search'])){
    $studentName = $_POST['studentName'];
    $conn = mysqli_connect("localhost", "root", "", "staff");
    $sql = "SELECT studentName, maths, english, science, creative_art, rme, ict, total, position, remarks FROM classThree WHERE studentName = '".$_POST['studentName']."'";
    ...
    <div class="row">
      <table class="table-bordered">
        ...
        <tbody>
            <?php
            $conn = mysqli_connect("localhost", "root", "", "staff");
            $sql = "SELECT studentName, maths, english, science, creative_art, rme, ict, total, position, remarks FROM classThree WHERE studentName = '$StudentName'";
            $query = mysqli_query($conn, $sql);

...
<body>
    ...
    <div class="container-fluid d-flex justify-content-center text-center shadow" id="class-heading">
        <div class="row">
            <div class="col-md-12">
                    <form method="POST" action="search.php" class="d-flex mt-4">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="awards-message">
                            <h4 class="text-center mt-1 p-1">PRIMARY TWO EXAM RECORDS</h4>
                        </div>
                    </div>
            ...
            $sql = "SELECT studentName, maths, english, science, creative_art, total, position FROM classTwo";
              ...
              while($row = mysqli_fetch_assoc($query)){
                  ?>
                            <tr class="text-center">
                                ...
                                <td>
                                    <form action="print-data.php" method="POST">
                                        <input type="hidden" name="id" value="">
                                ...
                                function editData(id) {
                                    if (confirm("Are you sure you want edit this data?")) {

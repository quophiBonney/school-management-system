...
<title>Primary Six Exam Records</title>
<!--Custom CSS -->
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="awards-message">
          <h4 class="text-center mt-1 p-1">PRIMARY SIX EXAM RECORDS</h4>
        </div>
      </div>
      <table class="table bordered">
        ...
        <tbody>
            ...
            $sql = "SELECT studentName, maths, english, science, creative_art, rme, ict, total, position, remarks FROM classSix";

...
if(isset($_POST['record'])) {
    ...
    $rme = $_POST['rme'];
    $ict = $_POST['ict'];
    $total = $_POST['maths'] + $_POST['english'] + $_POST['science'] + $_POST['creative_art'] + $_POST['rme'] + $_POST['ict'];
    ...
    if($studentName == "$studentName" && $position == "$position") {
      ...
      if($num > 0) {
        ...
        $sql = "INSERT INTO classFive(studentName, maths, english, science, creative_art, rme, ict, total, position, remarks)

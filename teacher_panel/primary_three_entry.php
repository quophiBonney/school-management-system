...
if(isset($_POST['record'])) {
    ...
    if($studentName == "$studentName" && $position == "$position") {
       $isStudentnameTaken = "SELECT * FROM classThree WHERE studentName = '".$_POST['studentName']. "'";
       ...
       $num = mysqli_num_rows($result);
        ...
        $sql = "INSERT INTO classThree(studentName, maths, english, science, creative_art, rme, ict, total, position, remarks)
...
<div class="container justify-content-center">
    <div class="row justify-content-center">
        <div class="col-md-6 p-3 my-4 shadow" id="login-section">
            <h4 class="text-center p-3">PRIMARY THREE EXAMS ENTRIES</h4>
            <hr>

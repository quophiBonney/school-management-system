...
<div class="container-fluid justify-content-center">
  <div class="row">
    <div class="col-md-12">
      <h5 class="p-1">SCIENCE & ICT FACILITIES</h5>
    </div>
    <div class="col-md-3">
      <img class="awards-img" src="images/photo-1612117189122-6b065b74f4bd.jfif">
    </div>
    <div class="col-md-3">
      <img class="awards-img" src="images/ict.jfif" width="250" height="250">
    </div>
    <div class="col-md-3">
      <img class="awards-img" src="images/computer_lab1.jpg" width="250" height="250">
    </div>
    <div class="col-md-3">
      <img class="awards-img" src="images/computer_lab.jpg" width="250" height="250">
    </div>
  </div>
</div>
<div class="space-out"></div>
...
<div class="container-fluid justify-content-center">
  <div class="row">
    <div class="col-md-12">
      <h5 class="p-1">SPORTS FACILITIES</h5>
    </div>
    <div class="col-md-3">
      <img class="sports-img" src="images/photo-1612117189122-6b065b74f4bd.jfif">
    </div>
    <div class="col-md-3">
      <img class="sports-img" src="images/ict.jfif" width="250" height="250">
    </div>
    <div class="col-md-3">
      <img class="sports-img" src="images/computer_lab1.jpg" width="250" height="250">
    </div>
    <div class="col-md-3">
      <img class="sports-img" src="images/computer_lab.jpg" width="250" height="250">
    </div>
  </div>
</div>
<div class="space-out"></div>
...
<div class="container-fluid justify-content-center">
  <div class="row">
    <div class="col-md-12">
      <h4 class="font-weight-bolder">ACADAMICS FACILITIES</h4>
      <hr>
    </div>
    <div class="col-md-3">
      <img class="awards-img" src="images/ict.jfif">
    </div>
    <div class="col-md-3">
      <img class="awards-img" src="images/classroom.jfif" alt="classroom studies">
    </div>
    <div class="col-md-3">

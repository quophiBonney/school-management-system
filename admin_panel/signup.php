...
if($password == $repeatPassword){
    $isParentnameTaken = "SELECT * FROM admin WHERE name = '$name' AND email = '$email'";
...
<div class="container">
    ...
    <div class="col-md-6 text-center">
        ...
        <h5 class="text-center text-dark"><marquee>ADMIN SIGNUP</marquee></h5>
        <small class="text-center font-weight-bold">kindly signup as an admin</small>
            ...
            <div class="form-group button">
            <a class="text-dark float-center" href="login.php">Already Signup?</a>
</div>
        </form>
      <p></p>
     <br><br>
